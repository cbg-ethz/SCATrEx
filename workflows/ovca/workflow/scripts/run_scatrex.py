...
# Run SCATrEx
args = dict(num_global_noise_factors=n_factors, unobserved_factors_kernel_concentration=1e-3,
            unobserved_factors_kernel_rate=1.,
            global_noise_factors_precisions_shape=2.)
...
MOVE_WEIGHTS = {
    ...
    "optimize_node": 1,
    "transfer_factor": 0.,
    "transfer_unobserved": 0.,
}
import logging
search_kwargs = {'n_iters': n_iters, 'n_iters_elbo': 100,
