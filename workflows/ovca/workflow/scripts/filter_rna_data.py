...
# TOV2295 (solid tumor)
tov_scrna = sc.read_10x_mtx(
    os.path.join(
        snakemake.input["clonealign_data_path"],
        "T_OV2295/10X/TOV2295/outs/filtered_gene_bc_matrices/hg19/",
    )
)
# OV2295 (ascites)
ov_scrna = sc.read_10x_mtx(
    os.path.join(
        snakemake.input["clonealign_data_path"],
        "T_OV2295/10X/OV2295n2/outs/filtered_gene_bc_matrices/hg19/",
    )
)
